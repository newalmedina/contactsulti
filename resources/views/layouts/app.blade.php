...
<body id="kt_body"
    ...
    <div id="app">
        ...
        <div id="kt_quick_user" class="offcanvas offcanvas-right p-10 ">
            ...
            <!--end::Header-->
            <!--begin::Content-->
            <div class="offcanvas-content pr-5 mr-n5 scroll ps" style="height: 652px; overflow: hidden;">
                <!--begin::Header-->
        ...
        <div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
            ...
            <div class="offcanvas-content px-10">
                <div class="tab-content">
                    <!--begin::Tabpane-->
                    <div class="tab-pane fade show pt-3 pr-5 mr-n5 active scroll ps ps--active-y"
                        id="kt_quick_panel_logs" role="tabpanel" style="height: 647px; overflow: hidden;">
                        <!--begin::Section-->
                        <div class="mb-15">
                        ...
                        <div class="ps__rail-y" style="top: 0px; height: 647px; right: 0px;">
                            <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 300px;"></div>
                        </div>
                    </div>
                    <!--end::Tabpane-->
                    <!--begin::Tabpane-->
                    <div class="tab-pane fade pt-2 pr-5 mr-n5 scroll ps" id="kt_quick_panel_notifications"
                        role="tabpanel" style="height: 647px; overflow: hidden;">
                        <!--begin::Nav-->
                    ...
                    <div class="tab-pane fade pt-3 pr-5 mr-n5 scroll ps" id="kt_quick_panel_settings" role="tabpanel"
                        style="height: 647px; overflow: hidden;">
                        <form class="form">
                            <!--begin::Section-->
                            <div>
        ...
        <div id="kt_demo_panel" class="offcanvas offcanvas-right p-10">
            ...
            <div class="offcanvas-content">
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull scroll ps ps--active-y"
                    style="height: 593px; overflow: hidden;">
                    <h5 class="font-weight-bold mb-4 text-center">Demo 1</h5>
                    <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo1.png')}}" alt=""
                                class="w-100">
                        </div>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo2.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo3.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo4.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo5.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo6.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo7.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo8.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo9.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo10.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo11.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo12.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo13.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo14.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo15.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo16.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo17.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo18.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo19.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo20.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo21.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo22.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo23.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo24.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo25.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo26.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo27.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo28.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo29.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{asset('assets//../../../../../../doc/assets/img/demos/demo30.png')}}" alt=""
                                class="w-100">
                        </div>
                        <div class="overlay-layer">
                            <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled">Coming soon</a>
                    ...
                    <div class="ps__rail-y" style="top: 0px; height: 593px; right: -2px;">
